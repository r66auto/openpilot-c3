...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._AWARENESS_TIME = 3000000000003. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 1000000000051.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 6.
    self._DISTRACTED_TIME = 100000000001. # active monitoring total timeout
